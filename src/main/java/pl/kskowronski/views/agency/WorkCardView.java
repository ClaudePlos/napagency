...
public class WorkCardView extends Dialog {
    ...
    private void generatePDF() {
        ...
        report.getReportBuilder()
                ...
                .addColumn(ColumnBuilder.getNew().setColumnProperty("hiHoursPlan", Double.class).setTitle("Plan").setStyle(headerStyle).setWidth(30).build())
                .addColumn(ColumnBuilder.getNew().setColumnProperty("hiHoursOverworked", Double.class).setTitle("Wykonanie").setStyle(headerStyle).setWidth(30).build())
